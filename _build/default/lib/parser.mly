...
delete_pattern:
| vns = separated_nonempty_list(COMMA, node  )  { DeleteNodes vns }
| rls = separated_nonempty_list(COMMA, relation)  { DeleteRels rls }

node : LPAREN; id = IDENTIFIER; RPAREN { id }

relation: LPAREN; v1 = IDENTIFIER; RPAREN; SUB; LBRACKET; COLON; lbl = IDENTIFIER; RBRACKET; ARROW; LPAREN; v2 = IDENTIFIER; RPAREN { (v1, lbl, v2) }

assignment_pattern: vn = IDENTIFIER; DOT; fn = IDENTIFIER; EQ; e = expr { (vn, fn, e) }
